...
5.  Causal diagrams help researchers to clarify causal assumptions, however, to address the causal crisis in observational psychologists require repeated-measures data.
...
The world is dynamic. Science learns the world's structure only slowly. The modified disjunctive criterion minimises reliance on any specific causal diagram. Yet we cannot known whether our confounding control strategy was successful. For this reason, we recommend sensitivity analysis. In our research, we report E-values [@vanderweele2017]. We reserve discussion of sensitivity analysis for future reports.
...
Psychological science faces a casual crisis whose magnitude has yet to be fully appreciated [@bulbulia2022]. It is encouraging that many psychological scientists are better understanding the importance of longitudinal data collection, but there is considerable work to be done still. Causal diagrams will continue to help psychological scientists to appreciate the discipline's causal crisis, however, the causal crisis will not be resolved with causal diagrams alone. Needed are longitudinal data.

## Acknowledgements 

I am grateful to Templeton Religion Trust Grant 0418 for supporting my work.^[The funders played no role in the design or interpretation of this research.]
