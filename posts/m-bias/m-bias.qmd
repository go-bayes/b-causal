...
[Elsewhere](https://go-bayes.github.io/b-causal/posts/outcomewide/outcome-wide.html) we described reasons for including indicators for both the exposure and outcome at baseline. Our discussion of M-bias reveals additional reasons. 

We have assumed that (unmeasured) childhood schooling causes perfectionism, the exposure. By including measures of the exposure at baseline, the effect of childhood schooling on perfection would need to be orthogonal to its effect at baseline.  

We have assumed that (unmeasured) childhood religions causes humility, the outcome By including measures of the outcome at baseline, the effect of childhood religion on humility would need to be orthogonal to its effect at baseline.  

As indicated in @fig-4, including measures for both the exposure and outcome at baseline provides a powerful check on unmeasured confounding because any such unmeasured confounding would need to be orthogonal to its effects at baseline.
**Such a strategy requires collecting at least three-waves of panel data.**



## Causal crisis in psychology cannot be fixed with graphs: needed are time series data

Psychological science faces a casual crisis whose magnitude has yet to be fully appreciated [@bulbulia2022]. 

This crisis will not be saved by causal graphs. Needed are at least three waves of repeated measures time-series data. 

We strongly advise observational psychological scientists to collect repeated-measures data. 
