...
Here, we have considered the threat of pre-treatment biases, and M-bias. We have considered how a modified disjunctive cause criterion addresses this bias, and why the inclusion at baseline of indicators both for the exposure and the outcome is an especially powerful strategy for confounding control.

We believe that psychological science faces a casual crisis whose magnitude has yet to be fully appreciated [@bulbulia2022]. Causal diagrams help us to understand the crisis, however, the crisis will not be resolved with causal diagrams. Needed is the collection of time-series data. With at at least three waves of repeated measures time-series data researchers may dramatically improve the quality of causal estimation. We strongly encourage observational psychological scientists to seek and collect repeated-measures data.
