...
4. Conspiracy Beliefs: the average mistrust of official versions of major world events given by authorities fell a little during the lockdown and remained lower. This decline might ari

The graph reveals that while the mean of trust in science increased, so too did the density of people at the extremes of the scale. This finding suggests greater separation or spread in attitudes to science in New Zealand. This finding is also a reminder that a central tendency may not always be the most interesting statistic for understanding social change.

### NZAVS sample responses: years 2018-2022

We have seen that different dimensions of institutional trust follow different patterns of change over time. 

We first investigate change within the sample who remained in the study. It is critical to remember that panel attrition could potentially result in biased estimates. If institutional trust is associated with attrition then an anlaysis that restricts to the observed sample will not accurately recorded change across the country. Knowing nothing else, we may assume bias. Even though the NZAVS employs prize draws as incentives for participants, those who lose trust in science may be less inclined to continue participating in the study.
...
How should we in interpret these findings? We should not interpret these findings.  Again, missing data from non-response and panel attrition may bias estimates for the population. We must address bias from missing responses.
...
Summary:
All models of the multiply imputed datasets were weighted to reflect changes in population averages.  The results show a reliable increase in trust in science from 2019 to 2020.  However, changes in trust in politicians, trust in police, trust in the government's COVID response, and conspiracy beliefs across the waves were generally unreliable. This suggests that trust in science has shown some improvement, while other forms of trust and beliefs have not shown consistent or reliable changes over time.  However, this is because there is considerable uncertainty from the multiple imputation process.  Stepping back, the evidence points to greater loss in average levels of institutional trust following COVID, but not in to a loss in average scientific confidence. 

In the near future, we will consider models that give us insight beyond the average response, and that better account for uncertainty.   
...
-   This confidence in science remained even as there is evidence for strong declines in trust for the government's pandemic response and other forms of instititutial mistrust. 
